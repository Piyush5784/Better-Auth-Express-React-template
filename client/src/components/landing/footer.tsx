...
const footerLinks = {
  ...
  Legal: [
    ...
    { label: "Terms", href: "/terms" },
    {
      ...
      href: "https://github.com/oblien/openship/blob/main/LICENSE",
    },
  ],
};
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="th-text-muted mt-4 max-w-xs text-sm leading-relaxed">
              Open-source deployment platform. CLI, web dashboard, or desktop
              app. Install, connect, deploy.
            </p>
          </div>
          ...
          {Object.entries(footerLinks).map(([heading, links]) => (
            <div key={heading}>
              <h4 className="th-text-strong text-sm font-semibold">
                {heading}
              </h4>
